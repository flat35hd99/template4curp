#!/bin/sh -xe
#PBS -l select=1:ncpus=2:mpiprocs=1:ompthreads=2:jobtype=core
...
prefix_flat_system=/home/users/gu5/flat/hp36s
prefix_output_dir=$prefix_flat_system/6hcond

## output directory setting
output_dir=$prefix_output_dir/test_ncpu_2_umpthreads_2/$data_id
if [ ! -e $output_dir ]
then
  mkdir -p $output_dir
else
